    ...
    <div className="relative min-h-screen overflow-hidden bg-black px-4 py-8 sm:px-6 lg:px-8" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center justify-center">
        <div className="grid w-full grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
          {/* Hero */}
          <div className={`order-2 flex flex-col items-center text-center transition-all duration-1000 ease-out ${show ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
            <h1
            ...
            <p className="mt-4 max-w-md text-sm text-white/75 sm:text-base">
              Create your account and join your campus marketplace universe.
            </p>
          </div>
          ...
          <div className="order-1 mx-auto w-full max-w-lg">
            <div className={`relative rounded-[28px] border border-white/15 bg-white/10 p-6 shadow-[0_20px_80px_rgba(0,0,0,0.55)] backdrop-blur-2xl transition-all duration-700 ease-out sm:p-8 md:p-10 ${show ? "translate-y-0 opacity-100 scale-100" : "translate-y-10 opacity-0 scale-95"}`}>
              <div className="relative z-10">
                <p className="mb-2 text-sm font-medium uppercase tracking-[0.3em] text-white/60">New account</p>
                <h2
                ...
                <form onSubmit={handleSignup} className="space-y-5">
                  <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="Username" required className="w-full rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-white placeholder:text-white/45 outline-none focus:border-fuchsia-400 focus:shadow-[0_0_0_4px_rgba(192,132,252,0.18)]" />
                  <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" required className="w-full rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-white placeholder:text-white/45 outline-none focus:border-fuchsia-400 focus:shadow-[0_0_0_4px_rgba(192,132,252,0.18)]" />
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full rounded-2xl border border-white/15 bg-white/10 px-4 py-3 pr-12 text-white placeholder:text-white/45 outline-none focus:border-fuchsia-400 focus:shadow-[0_0_0_4px_rgba(192,132,252,0.18)]"
                    />
                    <button
                      type="button"
                  ...
                  >
                    ...
                    <span className="relative z-10">{busy === "submit" ? "Creating account…" : "Create Account"}</span>
                  </button>
                </form>
                ...
                <div className="mt-6 space-y-3 text-sm sm:text-base">
                  <p className="text-white/70">
                    ...
                    <Link to="/login" className="font-semibold text-[#c9963f] transition-colors duration-200 hover:text-[#d6bd97]">Sign in</Link>
                  </p>
                </div>

                {/* Floating popup message */}
                {popupVisible && (
                  <div className="fixed top-6 right-6 z-50 w-72 rounded-xl bg-gradient-to-r from-green-400 to-teal-400 p-4 text-white font-bold shadow-lg animate-slide-in">
                    {message}
                  </div>
                )}
              </div>
